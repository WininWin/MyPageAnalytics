...
<html lang="en">
 ...
 <link rel="stylesheet" href="https://ajax.googleapis.com/ajax/libs/angular_material/1.1.1/angular-material.min.css">
  ...
  <link rel="stylesheet" href="./ThirdPartylib/jqcloud.min.css"/>
 ...
 <script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.5.7/angular.min.js"></script>
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/angular_material/1.1.1/angular-material.min.js"></script>
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/d3/3.5.6/d3.min.js" charset="utf-8"></script>
    ...
    <script src="./ThirdPartylib/jqcloud.min.js"></script>

    <script src="./ThirdPartylib/angular-jqcloud.js"></script>
  ...
  <body ng-app="MyPageAnalytics">
    ...
    console.log('1.statusChangeCallback');
